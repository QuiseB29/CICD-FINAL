...
// call on function to handle the shopping cart. Adding, Removing,  checking out
const ShoppingCart = () => {
    ...
    // renders the product name by search query
    ...
    // renders total sprice for all items in the cart
